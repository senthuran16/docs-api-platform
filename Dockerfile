# Stage 1: Build the MkDocs static site for the unversioned platform content
# (Overview, Get Started, Cloud, Analytics, Monetization, Policy Hub, Guides,
# Tools). Unlike a versioned product's branch, there's nothing to trim here -
# this branch only ever holds this one, unversioned nav.
