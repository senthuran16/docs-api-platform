...
description: "Understand the default user, role, and permission configuration in the registry and links to related tasks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/admin-working-with-users-roles-and-permissions/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/admin-working-with-users-roles-and-permissions.md
tags:
  - api-manager
  - install-and-setup
  - setup
