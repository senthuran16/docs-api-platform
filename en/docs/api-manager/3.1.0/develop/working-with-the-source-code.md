...
description: "Points to the GitHub repositories and build tooling for cloning and building WSO2 API Manager source code."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/working-with-the-source-code/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/working-with-the-source-code.md
tags:
  - api-manager
  - develop
