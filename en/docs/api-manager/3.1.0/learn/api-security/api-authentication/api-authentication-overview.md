...
description: "Compare the OAuth2, API key, mutual SSL, and basic authentication mechanisms available to secure APIs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/api-authentication/api-authentication-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/api-authentication/api-authentication-overview.md
tags:
  - api-manager
  - learn
  - api-security
