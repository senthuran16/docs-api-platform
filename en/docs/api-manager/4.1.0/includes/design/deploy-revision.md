...
2. Navigate to the **Deploy** section and click **Deployments**.
      ...
      [![New revision](/bijira/docs/api-manager/4.1.0/assets/img/design/revision/deploy-first-revision.png){: style="width:80%"}](/bijira/docs/api-manager/4.1.0/assets/img/design/revision/deploy-first-revision.png)

      The Deployments page appears as follows when you have at least one revision.

      [![Deploy new revision option](/bijira/docs/api-manager/4.1.0/assets/img/design/revision/deploy-new-revision.png)](/bijira/docs/api-manager/4.1.0/assets/img/design/revision/deploy-new-revision.png)
...
!!! warning
    You cannot deploy more than 5 revisions. If you want to deploy a new revision after the maximum allowed number of revisions are reached, you need to delete one of the existing revisions.
     ...
     [![Delete revision if max count is reached](/bijira/docs/api-manager/4.1.0/assets/img/design/revision/delete-and-deploy-revision.png){: style="width:60%"}](/bijira/docs/api-manager/4.1.0/assets/img/design/revision/delete-and-deploy-revision.png)
