...
description: "Get an overview of Choreo Insights pages available for viewing API business analytics in API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/api-analytics/viewing/introduction-to-api-analytics-dashboard/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/api-analytics/viewing/introduction-to-api-analytics-dashboard.md
tags:
  - api-manager
  - api-analytics
  - viewing
