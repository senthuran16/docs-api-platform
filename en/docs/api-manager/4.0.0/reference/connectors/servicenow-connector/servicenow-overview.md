...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/servicenow-connector/servicenow-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/servicenow-connector/servicenow-overview.md
tags:
  - api-manager
  - reference
  - connectors
