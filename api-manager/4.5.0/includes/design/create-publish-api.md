...
4. Select **API Key**. Note that `APIKey` is used as the default header. This value can be changed using the `APIKey Header` field.
     ...
     [![Configure API key authentication](/api-platform/docs/api-manager/4.5.0/assets/img/learn/api-key-option.png)](/api-platform/docs/api-manager/4.5.0/assets/img/learn/api-key-option.png)
