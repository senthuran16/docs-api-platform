...
2. Navigate to the **Deploy** section and click **Deployments**.
      ...
      [![New revision](/api-platform/docs/api-manager/4.5.0/assets/img/design/revision/deploy-first-revision.png){: style="width:80%"}](/api-platform/docs/api-manager/4.5.0/assets/img/design/revision/deploy-first-revision.png)

      The Deployments page appears as follows when you have at least one revision.

      [![Deploy new revision option](/api-platform/docs/api-manager/4.5.0/assets/img/design/revision/deploy-new-revision.png)](/api-platform/docs/api-manager/4.5.0/assets/img/design/revision/deploy-new-revision.png)
...
!!! warning
    You cannot deploy more than 5 revisions. If you want to deploy a new revision after the maximum allowed number of revisions are reached, you need to delete one of the existing revisions.
     ...
     [![Delete revision if max count is reached](/api-platform/docs/api-manager/4.5.0/assets/img/design/revision/delete-and-deploy-revision.png){: style="width:60%"}](/api-platform/docs/api-manager/4.5.0/assets/img/design/revision/delete-and-deploy-revision.png)