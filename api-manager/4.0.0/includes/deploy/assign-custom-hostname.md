...
3.  Click on the API to edit its configurations.
     ...
     [![Edit the API](/api-platform/docs/api-manager/4.0.0/assets/img/includes/deploy/select-api.png)](/api-platform/docs/api-manager/4.0.0/assets/img/includes/deploy/select-api.png)

4.  Click **Deployments**.

5.  Select the newly created Gateway environment, Virtual Host (foods.com), and a Revision.

     [Create a new revision](/api-platform/docs/api-manager/4.0.0/design/create-api/create-api-revisions/) if no revisions exist.
