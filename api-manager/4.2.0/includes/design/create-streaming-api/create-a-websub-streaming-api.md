...
You can create a WebSub API from scratch in WSO2 API-M and export the WebSub APIs that are created within WSO2 API-M as AsyncAPI definitions. Alternatively, you can also import [existing AsyncAPI definitions to create SSE APIs in WSO2 API-M](/api-platform/docs/api-manager/4.2.0/use-cases/streaming-usecase/create-streaming-api/create-a-streaming-api-from-an-asyncapi-definition/).
...
4.  Click **CREATE**.
     ...
     [![Overview of WebSub API](/api-platform/docs/api-manager/4.2.0/assets/img/tutorials/streaming-api/websub-api-overview.png)](/api-platform/docs/api-manager/4.2.0/assets/img/tutorials/streaming-api/websub-api-overview.png)
...
2. Modify the topics as follows and click **Save** to update them.
    ...
    1. Optionally, click delete, as shown below, to delete an existing topic.
        ...
        <a href="/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-delete-default-topic.png"><img src="/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-delete-default-topic.png" width="80%" alt="WebSub API Delete Existing Topic"></a>

    2. Select **sub** under **Types**, enter the **Topic Name**, and click **+** as shown below, to add a new topic.

         <a href="/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-add-topic.png"><img src="/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-add-topic.png" width="80%" alt="WebSub API Add Topic"></a>

         The newly added topic is displayed as follows.

         <a href="/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-api-newly-added-topic.png"><img src="/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-api-newly-added-topic.png" width="80%" alt="WebSub API Newly Added Topic"></a>
...
The AsyncAPI definition of the streaming API, which you just created, appears.
   ...
   <a href="/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-api-asyncapi.png"><img src="/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-api-asyncapi.png" width="80%" alt="WebHook API AsyncAPI Definition"></a>
...
1. Click **Runtime** under **API Configurations**.
    ...
    [![WebSub API Runtime Configurations Page](/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-api-runtime-configurations.png)](/api-platform/docs/api-manager/4.2.0/assets/img/design/create-api/streaming-api/websub-api-runtime-configurations.png)
...
4. Click **Generate**, which will generate a secret.
     ...
     <a href="/api-platform/docs/api-manager/4.2.0/assets/img/tutorials/streaming-api/websub-api-generate-secret.png"><img src="/api-platform/docs/api-manager/4.2.0/assets/img/tutorials/streaming-api/websub-api-generate-secret.png" width="80%" alt="WebSub API Generate Secret"></a>
...
Learn more by trying out an end-to-end tutorial on <a href="/api-platform/docs/api-manager/4.2.0/tutorials/streaming-api/create-and-publish-websub-api/">Creating and Publishing a WebSub API</a>, which uses the default Streaming Provider that works with WSO2 API Manager, namely the WSO2 Streaming Integrator.
