...
4. Run `npm start` to start the server.
    ...
    [![CLI output](/api-platform/docs/api-manager/4.4.0/assets/img/learn/cli-output.png){: style="width:45%"}](/api-platform/docs/api-manager/4.4.0/assets/img/learn/cli-output.png)
...
2. Click **Create API** and then click **Import GraphQL SDL**.
     ...
     [![Create GraphQL Schema Option](/api-platform/docs/api-manager/4.4.0/assets/img/learn/create-graphql-schema-option.png)](/api-platform/docs/api-manager/4.4.0/assets/img/learn/create-graphql-schema-option.png)

3. Import the schema by dragging and dropping the file or by uploading the file, and click **Next**.

       Let's use the [StarWarsAPI schema definition](/api-platform/docs/api-manager/4.4.0/assets/attachments/learn/schema_graphql.graphql) to create the schema file. 
      ...
      [![Import a GraphQL schema by adding a file](/api-platform/docs/api-manager/4.4.0/assets/img/learn/import-graphql-schema-via-file.png){: style="width:80%"}](/api-platform/docs/api-manager/4.4.0/assets/img/learn/import-graphql-schema-via-file.png)
...
4. Enter the GraphQL API related details and click **Create**.
    ...
    Let's create an API named "StarWarsAPI" using the following sample data.
      ...
      Thereafter, the API Gateway will use this WebSocket URL as the backend subscription endpoint of the GraphQL API.</li> 
       ...
       [![Add GraphQL API details](/api-platform/docs/api-manager/4.4.0/assets/img/learn/create-graphql-api-details.png){: style="width:75%"}](/api-platform/docs/api-manager/4.4.0/assets/img/learn/create-graphql-api-details.png)
...
5. Optionally, modify the existing GraphQL schema definition.
    ...
    2. Click **Download Definition**.
         ...
         [![Add schema definition](/api-platform/docs/api-manager/4.4.0/assets/img/learn/download-schema-definition.png){: style="width:80%"}](/api-platform/docs/api-manager/4.4.0/assets/img/learn/download-schema-definition.png)
...
6. Update the GraphQL API operations as required.
    ...
    1. Click **Show More** under the **Operations** section in the **Overview** page to navigate to the operations page.
         ...
         [![GraphQL API operations](/api-platform/docs/api-manager/4.4.0/assets/img/learn/operations.png)](/api-platform/docs/api-manager/4.4.0/assets/img/learn/operations.png)  
    ...
    2. Update the operations as required.
        ...
        1. **Create scopes**.
            ...
            1. Click **Local Scopes**, and then click **Create Scopes**.
                ...
                [![Add a scope page](/api-platform/docs/api-manager/4.4.0/assets/img/learn/add-scope.png)](/api-platform/docs/api-manager/4.4.0/assets/img/learn/add-scope.png)
            ...
            2. Enter the required details.
                   ...
                   [![Create a scope](/api-platform/docs/api-manager/4.4.0/assets/img/learn/create-scope.png)](/api-platform/docs/api-manager/4.4.0/assets/img/learn/create-scope.png)

            3. Press `Enter` to add each role. 

            4. Click **Save**.

                 [![List of added scopes](/api-platform/docs/api-manager/4.4.0/assets/img/learn/starwars-scope-list.png)](/api-platform/docs/api-manager/4.4.0/assets/img/learn/starwars-scope-list.png)
         ...
         2. **Define the operation level configurations**.
            ...
            2. Click **Operation Level** to apply Rate Limiting for operations.
                ...
                [![Update GraphQL API operations](/api-platform/docs/api-manager/4.4.0/assets/img/learn/update-operations.png)](/api-platform/docs/api-manager/4.4.0/assets/img/learn/update-operations.png) 
            ...
            4. Click **Save**.
                 ...
                 [![Scope list](/api-platform/docs/api-manager/4.4.0/assets/img/learn/scope-list.png)](/api-platform/docs/api-manager/4.4.0/assets/img/learn/scope-list.png)